...
```{r}
providers_per_1000_zip <- function(taxonomy, zipcode) {
numberprovidersper1000zip <- length(NPIcode_taxonomy(taxonomy, zipcode))
ratio <- return(numberprovidersper1000state) / #census population / 1000
}
