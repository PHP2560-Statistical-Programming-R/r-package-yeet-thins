...
NPIcode_taxonomy<-function(zipcode,taxonomy){
  ...
  provider.data <- rbind(provider.data,reps) #binding together the provider data and reps data
   ...
   colnames(provider.data) <- c("NPI","Name","NPI_Type","Primary_Practice_Address","Phone","Primary_Taxonomy","zipcode") #the next three lines clean the data set
...
```
##Comment
The next lines of code all have been added into the mega function
```{r}
...
NPI_join<-full_join(provider.data.work, zip_link, by="zipcode")
head(NPI_join)
